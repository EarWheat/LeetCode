package leetcode.One.Thousand.maxRepeating;
 ...
 * @Desc:
 * @Author: 泽露
 * @Date: 2022/11/3 11:27 AM
 * @Version: 1.initial version; 2022/11/3 11:27 AM
 */
public class Solution {
    public int maxRepeating(String sequence, String word) {
        StringBuilder stringBuilder = new StringBuilder();
        int result = 0;
        while (stringBuilder.length() < sequence.length()) {
            StringBuilder temp = stringBuilder.append(word);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(sequence.split(word)));
