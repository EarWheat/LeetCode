package leetcode.One.Thousand.reorderSpaces;
...
/**
 * @Desc: 1592 重新排列单词间的空格
 * @Author: 泽露
 * @Date: 2022/9/7 2:55 PM
 * @Version: 1.initial version; 2022/9/7 2:55 PM
 */
public class Solution {
    public String reorderSpaces(String text) {
        ...
        if(word == 1){
            stringBuilder.append(str.get(0));
            for (int i = 0; i < num; i++) {
        ...
        stringBuilder.append(str.get(str.size() - 1));
        for (int i = costGap; i < num; i++) {
            stringBuilder.append(" ");
        }
        return stringBuilder.toString();
    }
