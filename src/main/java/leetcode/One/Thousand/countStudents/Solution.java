package leetcode.One.Thousand.countStudents;
 ...
 * @Desc:
 * @Author: 泽露
 * @Date: 2022/10/19 10:26 AM
 * @Version: 1.initial version; 2022/10/19 10:26 AM
 */
...
//
// Related Topics 栈 队列 数组 模拟 👍 81 👎 0
public class Solution {
    public int countStudents(int[] students, int[] sandwiches) {
        Queue<Integer> queue = new ArrayDeque<>();
        Arrays.stream(students).forEach(queue::add);
